...
public abstract class RecipesDatabase extends RoomDatabase {
    ...
    static RecipesDatabase getDatabase(final Context context) {
        if (INSTANCE == null) {
            synchronized (RecipesDao.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                                    RecipesDatabase.class, "recipes-database")
                            .build();
                }
            }
        }
...
//            super.onCreate(db);
//            databaseWriteExecutor.execute(RecipesDatabase::creatingRecipes);
//        }
//    };
//
//    private static void creatingRecipes() {
...
//
//        RecipesDao recipesDao = RecipesDatabase.getDatabase(this);
