...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new RecyclerViewAdapter(this, new ArrayList<>());
        ...
        backgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                creatingRecipes();
                List<Recipes> recipesList = getRecipes();
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        myAdapter.updateRecipes(recipesList);
    ...
    private List<Recipes> getRecipes() {
        RecipesDatabase recipesDatabase = RecipesDatabase.getDatabase(this);
        RecipesDao recipesDao = recipesDatabase.recipesDao();
        return recipesDao.getAll();
    }

    public void creatingRecipes() {
        List<Recipes> recipesList = new ArrayList<>();
        recipesList.add(new Recipes("Chicken Roll","200 gm chopped into cubes chicken" +
        ...
        RecipesDatabase recipesDatabase = RecipesDatabase.getDatabase(this);
        RecipesDao recipesDao = recipesDatabase.recipesDao();
        recipesDao.insertAll(recipesList);
